// SpectrumAnalyzer.cpp : アプリケーションのエントリ ポイントを定義します。
//
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow) {
	...
	clRiffWav->Load(L"", 44100, 1024, 0.5);
	clWaveOut = new WaveOut(44100, 2, Wave::EBufferType::FLOAT32, 1024, 8, WriteBuffer);
...
void WriteBuffer(LPSTR lpData) {
	...
	clRiffWav->fpRead(clRiffWav, (float*)lpData);
}