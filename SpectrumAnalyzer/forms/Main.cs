...
namespace SpectrumAnalyzer.Forms {
	public partial class Main : Form {
		...
		private void Form1_Load(object sender, EventArgs e) {
			...
			Playback.Spectrum.Transpose = Settings.Transpose;
			var pitchShift = Settings.Transpose + Settings.KeyCent / 100;
			Playback.Spectrum.Pitch = Math.Pow(2.0, pitchShift / 12.0);
