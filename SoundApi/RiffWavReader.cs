...
public class RiffWavReader : RiffWav {
	...
	public RiffWavReader() {
		SampleCount = 1;
	}

	public RiffWavReader(string filePath, int sampleRate = 44100, int outputSamples = 1024, double bufferUnitSec = 0.1) {
		IsOpened = false;
		try {
